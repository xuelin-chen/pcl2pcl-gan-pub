...
def get_model(point_cloud, is_training, bn_decay=None):
    ...
    l4_xyz, l4_points, l4_indices = point_conv_module(l3_xyz, l3_points,  npoint=8, c_fts_out=1024, k_neighbors=4,  d_rate=1, is_training=is_training, scope='conv_layer_4', sorting_method=sort_mtd)
    l5_xyz, l5_points, l5_indices = point_conv_module(l4_xyz, l4_points,  npoint=1, c_fts_out=1024, k_neighbors=8,  d_rate=1, is_training=is_training, scope='conv_layer_5', sorting_method=sort_mtd)
    ...
    '''
    # with U-net
    l4_xyz, l4_points = point_deconv_module(l5_xyz, l5_points, l4_xyz, l4_points, l5_indices, c_fts_out=1024, k_neighbors=8,  d_rate=1, is_training=is_training, scope='deconv_layer_1')
    l3_xyz, l3_points = point_deconv_module(l4_xyz, l4_points, l3_xyz, l3_points, l4_indices, c_fts_out=512,  k_neighbors=4,  d_rate=1, is_training=is_training, scope='deconv_layer_2')
    l2_xyz, l2_points = point_deconv_module(l3_xyz, l3_points, l2_xyz, l2_points, l3_indices, c_fts_out=256,  k_neighbors=8,  d_rate=1, is_training=is_training, scope='deconv_layer_3')
    l1_xyz, l1_points = point_deconv_module(l2_xyz, l2_points, l1_xyz, l1_points, l2_indices, c_fts_out=128,  k_neighbors=32, d_rate=1, is_training=is_training, scope='deconv_layer_4')
    l0_xyz, l0_points = point_deconv_module(l1_xyz, l1_points, l0_xyz, l0_points, l1_indices, c_fts_out=128,  k_neighbors=64, d_rate=1, is_training=is_training, scope='deconv_layer_5')
