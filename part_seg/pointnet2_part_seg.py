...
def get_model(point_cloud, is_training, bn_decay=None):
    ...
    '''
    l2_points = pointnet_fp_module(l2_xyz, l3_xyz, None, l3_points, [256,256], is_training, bn_decay, scope='fa_layer1')
    l1_points = pointnet_fp_module(l1_xyz, l2_xyz, None, l2_points, [256,128], is_training, bn_decay, scope='fa_layer2')
    l0_points = pointnet_fp_module(l0_xyz, l1_xyz, tf.concat([l0_xyz,l0_points],axis=-1), l1_points, [128,128,128], is_training, bn_decay, scope='fa_layer3')
    '''
    # FC layers
