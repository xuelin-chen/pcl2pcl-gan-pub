...
para_config_gan = {
    'exp_name': '%s_pcl2pcl_gan_3D-EPN_wGT_noGAN'%(cat_name),
    'random_seed': 0,
...
if cat_name == 'chair':
    ...
    para_config_gan['pcl2pcl_gan_ckpt'] = '/workspace/pointnet2/pc2pc/run_3D-EPN/run_chair/pcl2pcl_wGT_noGAN/log_chair_pcl2pcl_gan_3D-EPN_GT_noGAN_emd_2019-03-14-16-45-22/ckpts/model_0.ckpt'
    ...
    para_config_gan['pcl2pcl_gan_ckpt'] = '/workspace/pointnet2/pc2pc/run_3D-EPN/run_table/pcl2pcl_wGT_noGAN/log_table_pcl2pcl_gan_3D-EPN_GT_noGAN_emd_2019-03-14-16-49-45/ckpts/model_420.ckpt'
    ...
    para_config_gan['pcl2pcl_gan_ckpt'] = '/workspace/pointnet2/pc2pc/run_3D-EPN/run_plane/pcl2pcl_wGT_noGAN/log_plane_pcl2pcl_gan_3D-EPN_GT_noGAN_emd_2019-03-14-16-47-31/ckpts/model_720.ckpt' 
    ...
    para_config_gan['pcl2pcl_gan_ckpt'] = '/workspace/pointnet2/pc2pc/run_3D-EPN/run_car/pcl2pcl_wGT_noGAN/log_car_pcl2pcl_gan_3D-EPN_GT_noGAN_emd_2019-03-14-16-41-13/ckpts/model_710.ckpt'
...
def prepare4test():
    ...
    para_config_gan['LOG_DIR'] = os.path.join('test_3D-EPN', 'test_%s'%(cat_name), 'pcl2pcl_wGT_noGAN_test', 'all_models_ShapeNetV1-GT', 'log_test_' + para_config_gan['exp_name'] + '_' + model_name + '_' + datetime.now().strftime('%Y-%m-%d-%H-%M-%S'))
...
def test():
    ...
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(0)):
            ...
            _, _, _, _, _, _, fake_clean_reconstr, eval_loss = latent_gan.model_wGT_noGAN()
