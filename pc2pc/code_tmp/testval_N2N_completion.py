...
para_config = {
    'exp_name': 'ae_%s_%d-percentage'%(cat_name, pts_remove_percentage*100),
...
LOG_DIR = os.path.join('run_%s'%(cat_name), 'N2N_ae_test', 'log_test_' + para_config['exp_name'] +'_'+ para_config['ae_type'] + '_' + model_name + '_' + datetime.now().strftime('%Y-%m-%d-%H-%M-%S'))
