...
para_config = {
    'exp_name': 'ae_%s_%d-percantage'%(cat_name, pts_remove_percentage*100),
...
if cat_name == 'chair':
    ...
    para_config['ckpt'] = '/workspace/pointnet2/pc2pc/run_car/ae/log_ae_car_percentage_c2c_2019-03-06-15-50-06/ckpts/model_1900.ckpt'
