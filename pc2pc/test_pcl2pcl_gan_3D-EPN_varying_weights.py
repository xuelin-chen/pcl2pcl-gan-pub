...
cat_name = 'chair'
note = 'varying_weight_lambda=0.75'
...
if cat_name == 'chair':
    ...
    para_config_gan['pcl2pcl_gan_ckpt'] = '/workspace/pointnet2/pc2pc/run_3D-EPN/run_chair/pcl2pcl_varying_lambda/log_chair_pcl2pcl_gan_3D-EPN_varying_weight_lambda=0.75_hausdorff_2019-03-19-18-55-00/ckpts/model_?.ckpt'
    ...
    para_config_gan['pcl2pcl_gan_ckpt'] = '/workspace/pointnet2/pc2pc/run_3D-EPN/run_table/pcl2pcl_varying_lambda/log_table_pcl2pcl_gan_3D-EPN_varying_weight_lambda=0.75_hausdorff_2019-03-19-18-59-03/ckpts/model_?.ckpt'
...
def prepare4test():
    ...
    para_config_gan['LOG_DIR'] = os.path.join('test_3D-EPN', 'test_%s'%(cat_name), 'pcl2pcl_varying_lamda_test', 'all_models_ShapeNetV1-GT', 'log_test_' + para_config_gan['exp_name'] + '_' + model_name + '_' + datetime.now().strftime('%Y-%m-%d-%H-%M-%S'))
...
if __name__ == "__main__":
    ...
    for model_idx in range(200, 2681, 10):
