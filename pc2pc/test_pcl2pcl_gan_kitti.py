...
if cat_name == 'car':
    ...
    para_config_gan['pcl2pcl_gan_ckpt'] = '/workspace/pointnet2/pc2pc/run_kitti/run_car/pcl2pcl/log_car_pcl2pcl_gan_kitti_hausdorff_2019-03-19-17-13-32/ckpts/model_370.ckpt'
...
def prepare4test():
    ...
    para_config_gan['LOG_DIR'] = os.path.join('test_kitti', 'test_%s'%(cat_name), 'pcl2pcl_test', 'all_models_ShapeNetV1-GT', 'log_test_' + para_config_gan['exp_name'] + '_' + model_name + '_' + datetime.now().strftime('%Y-%m-%d-%H-%M-%S'))
...
if __name__ == "__main__":
    ...
    for model_idx in range(520, 521, 10):
